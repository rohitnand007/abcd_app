class Assessment < Content
  ...
  TEST_TYPES = [["Quiz","Quiz"],["Practice-Test","practice-tests"],["Institute-Test","insti-tests"]]
  #LOCATION = [["Home-Work","home-work"]]
  LOCATION = [["Institute","institute"],["Practice Test","practice"],["Home-Work","homework"]] #,["Hit the books","quiz"]
