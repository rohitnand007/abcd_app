...
(function($) {
    ...
    $.widget('ui.tagit', {
        ...
        _create: function() {
            ...
            // Autocomplete.
            if (this.options.tagSource) {
                var current_input_field = this._tagInput ;
                current_input_field.autocomplete({
                ...
                if(that.options.requireAutocomplete === true){
                    this.tagList.click(function(){
                        var current_source = current_input_field.autocomplete("option","source");
                        var current_minLength = current_input_field.autocomplete("option","minLength");
                        current_input_field.autocomplete("option","source",that.options.availableTags);
                        current_input_field.autocomplete("option","minLength",0);
                        //current_input_field.trigger('keydown');
                        current_input_field.autocomplete('search',"");
                        })
